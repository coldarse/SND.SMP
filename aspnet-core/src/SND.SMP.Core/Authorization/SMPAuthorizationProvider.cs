...
namespace SND.SMP.Authorization
{
    public class SMPAuthorizationProvider : AuthorizationProvider
    {
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            context.CreatePermission(PermissionNames.Pages_ItemTrackingEvent, L("ItemTrackingEvents"));
            context.CreatePermission(PermissionNames.Pages_ItemTrackingEvent_Create, L("ItemTrackingEventsCreate"));
            context.CreatePermission(PermissionNames.Pages_ItemTrackingEvent_Edit, L("ItemTrackingEventsEdit"));
            context.CreatePermission(PermissionNames.Pages_ItemTrackingEvent_Delete, L("ItemTrackingEventsDelete"));
            ...
            context.CreatePermission(PermissionNames.Pages_RateZone_Delete, L("RateZonesDelete"));

            context.CreatePermission(PermissionNames.Pages_Invoice, L("Invoices"));
            context.CreatePermission(PermissionNames.Pages_Invoice_Create, L("InvoicesCreate"));
            context.CreatePermission(PermissionNames.Pages_Invoice_Edit, L("InvoicesEdit"));
            context.CreatePermission(PermissionNames.Pages_Invoice_Delete, L("InvoicesDelete"));
            ...
            context.CreatePermission(PermissionNames.Pages_TrackingNoForUpdate_Delete, L("TrackingNoForUpdatesDelete"));
            ...
            context.CreatePermission(PermissionNames.Pages_ItemTrackingApplication_Export, L("ItemTrackingApplicationsExport"));
            ...
            context.CreatePermission(PermissionNames.Pages_Wallet_ManageCredit, L("ManageCredit"));
            ...
            context.CreatePermission(PermissionNames.Pages_DispatchTracking, L("DispatchTracking"));
            context.CreatePermission(PermissionNames.Pages_SearchItem, L("SearchItem"));
            ...
            context.CreatePermission(PermissionNames.Pages_APIItem, L("APIItem"));
