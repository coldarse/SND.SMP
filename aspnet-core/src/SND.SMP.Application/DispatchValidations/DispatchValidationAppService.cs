...
{
    public class DispatchValidationAppService : AsyncCrudAppService<DispatchValidation, DispatchValidationDto, long, PagedDispatchValidationResultRequestDto>
    {

        public DispatchValidationAppService(IRepository<DispatchValidation, long> repository) : base(repository)
        {
        }
