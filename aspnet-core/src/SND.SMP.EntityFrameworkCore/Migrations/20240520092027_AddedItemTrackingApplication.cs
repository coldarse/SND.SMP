...
{
    /// <inheritdoc />
    public partial class AddedItemTrackingApplication : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemTrackingApplications", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
