...
$ABP_HOST="dannychen98/tfs_api:v1.1.29"
...
$SMP_DISPATCH_3_DOCKERFILE_PATH="src/SND.SMP.ItemTrackingGenerator/Dockerfile"
$SMP_DISPATCH_4_DOCKERFILE_PATH="src/SND.SMP.ItemTrackingUpdater/Dockerfile"
$ABP_NG="dannychen98/tfs_ms:v1.1.19"
# $SMP_DISPATCH="dannychen98/tfs_dispatch_console:v1.1.7"
$SMP_DISPATCH_1="dannychen98/tfs_dispatch_importer:v1.0.5"
