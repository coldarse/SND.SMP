...
{
    public abstract class SMPWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SMPWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SMPWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SMPDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SMPDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SMPDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SMPDbContext, Task<T>> func)
        {
            T result;
