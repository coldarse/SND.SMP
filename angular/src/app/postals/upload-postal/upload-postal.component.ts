...
@Component({
  selector: "app-upload-postal",
  templateUrl: "./upload-postal.component.html",
  styleUrls: ["./upload-postal.component.css"],
})
export class UploadPostalComponent
  ...
  implements OnInit
{
  ...
  save(): void {
    ...
    this._postalService.uploadPostalFile(form).subscribe(
      () => {
